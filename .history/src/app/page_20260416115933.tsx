...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-black text-white font-sans w-full max-w-full overflow-x-hidden">
      ...
      <section id="about" className="w-full h-auto min-h-0 md:h-screen md:min-h-[300px] p-0 m-0 -mt-8 md:mt-0 flex justify-center items-center animate-fade-in bg-black relative overflow-hidden">
        <video
