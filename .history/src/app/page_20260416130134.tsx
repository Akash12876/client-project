...
import Signature3DScrollShowcase from "../components/Signature3DScrollShowcase";
...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-black text-white font-sans w-full max-w-full overflow-x-hidden">
      ...
      {/* Signature 3D Sticky Showcase */}
      <section id="signature-motion" className="animate-fade-in w-full max-w-full">
        <Signature3DScrollShowcase />
      </section>
