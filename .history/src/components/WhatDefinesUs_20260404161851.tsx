        ...
        <div className="relative w-full flex flex-col items-center justify-center gap-6 mt-4 lg:mt-0 bg-transparent" style={{minHeight: '520px', maxWidth: '700px', margin: '0 auto'}}>
          ...
          >
            <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
              <circle cx="32" cy="32" r="28" stroke="#A259FF" strokeWidth="2" />
              <ellipse cx="32" cy="32" rx="20" ry="8" stroke="#A259FF" strokeWidth="2" />
              <ellipse cx="32" cy="32" rx="12" ry="4" stroke="#A259FF" strokeWidth="2" />
              <circle cx="32" cy="32" r="6" fill="#A259FF" />
              <circle cx="48" cy="32" r="3" fill="#D1A3FF" />
              <circle cx="16" cy="32" r="3" fill="#D1A3FF" />
            </svg>
          </motion.div>
        </div>
      </motion.div>
