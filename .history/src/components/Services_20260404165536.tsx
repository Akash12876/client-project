          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className="absolute left-0 bottom-0 w-full h-full flex items-center justify-center z-10 pointer-events-none origin-bottom scale-y-0 group-hover/button:scale-y-100 group-hover/button:bg-black group-hover/button:text-white transition-transform duration-300 rounded-full">
                  <span className="w-full text-center font-bold">Know More</span>
                </span>
              </motion.button>
              {/* Decorative Glow */}
              <motion.div
