        ...
        <form className="flex-1 flex flex-col gap-8" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-6">
            <div>
              ...
              <input id="name" type="text" required className="w-full bg-transparent border-b-2 border-zinc-400 focus:border-[#a78bfa] text-white py-2 px-1 outline-none transition-all" />
            </div>
            <div>
            ...
            <div>
              ...
              <input id="phone" type="tel" required className="w-full bg-transparent border-b-2 border-zinc-400 focus:border-[#a78bfa] text-white py-2 px-1 outline-none transition-all" />
            </div>
            <div>
