    ...
    >
      ...
      >
        ...
        <div className="relative w-full flex flex-col items-center justify-center gap-6 mt-4 lg:mt-0 bg-transparent" style={{minHeight: '520px', maxWidth: '700px', margin: '0 auto'}}>
          ...
          <motion.div
            className="absolute top-0 right-0 bg-purple-500/70 text-white text-2xl md:text-3xl font-bold rounded-3xl px-4 md:px-8 py-6 md:py-8 max-w-xl w-[90vw] md:w-[420px] shadow-lg z-30 backdrop-blur-sm"
