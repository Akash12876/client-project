  ...
  return (
    <section className="w-full flex flex-col items-center justify-center py-20 px-2 md:px-0 bg-black">
      ...
      <div className="w-full max-w-5xl flex flex-col md:flex-row gap-8 md:gap-16 justify-center items-stretch">
        ...
        {/* Others Side */}
        <motion.div
          className="flex-1 bg-[#101010] rounded-3xl border-2 border-zinc-700 shadow-xl p-8 flex flex-col items-start justify-center group transition-all duration-500 relative"
          whileHover={{ scale: 1.03, boxShadow: "0 0 32px #ef444488", background: "#1a0000" }}
          transition={{ type: "spring", stiffness: 80, damping: 18 }}
        >
          <div className="flex items-center gap-3 mb-6">
            <div className="w-14 h-14 rounded-full bg-gradient-to-br from-zinc-700 to-zinc-900 flex items-center justify-center shadow-lg">
              {/* Bigger stacked layers icon */}
              <svg width="38" height="38" viewBox="0 0 38 38" fill="none">
                <circle cx="19" cy="19" r="19" fill="#101010"/>
                <g>
                  <path d="M11 18L19 14L27 18L19 22L11 18Z" stroke="#fff" strokeWidth="2.2" strokeLinejoin="round" fill="none"/>
                  <path d="M11 22L19 26L27 22" stroke="#fff" strokeWidth="2.2" strokeLinejoin="round" fill="none"/>
                  <path d="M11 18L19 22L27 18" stroke="#fff" strokeWidth="2.2" strokeLinejoin="round" fill="none"/>
                </g>
              </svg>
            </div>
