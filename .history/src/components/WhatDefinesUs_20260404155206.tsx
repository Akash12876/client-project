...
export default function WhatDefinesUs() {
  ...
  return (
    <motion.section
      className="w-full min-h-screen flex flex-col md:flex-row items-center justify-center px-2 md:px-0 py-16 bg-black relative"
    ...
    >
      ...
      >
        {/* Speech bubble */}
        <div className="relative w-full flex flex-col items-center justify-center gap-6 mt-4" style={{minHeight: '520px'}}>
          ...
          <motion.div
            className="absolute top-0 right-0 bg-purple-500 text-white text-2xl md:text-3xl font-bold rounded-3xl px-8 py-8 max-w-xl w-[420px] shadow-lg z-30"
          ...
          <motion.div
            className="absolute left-0 bottom-0 max-w-2xl w-[520px] h-[400px] md:h-[480px] rounded-3xl overflow-hidden shadow-2xl z-20"
          ...
          <motion.div
            className="absolute left-[160px] bottom-8 h-0.5 w-32 border-dashed border-t-2 border-white opacity-60 z-10"
            initial={{ scaleX: 0 }}
          ...
          <motion.div
            className="absolute left-[320px] bottom-0 w-14 h-14 bg-white rounded-full border-4 border-purple-300 z-20"
            initial={{ scale: 0 }}
            whileInView={{ scale: 1 }}
            viewport={{ once: true, amount: 0.3 }}
