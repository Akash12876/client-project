...
function useCountUp(target: number, duration = 2.4, start = false) {
...
function LargeCard({ stat, inView }: { stat: typeof stats[0]; inView: boolean }) {
  const count = useCountUp(stat.value, 2.4, inView);
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-7 right-7 opacity-35">
        <Ring progress={stat.progress} color={stat.color} size={90} stroke={3} inView={inView} delay={0.5}/>
      </div>
      <div className="relative z-10">
        ...
        <div className="flex items-end gap-1 mb-3">
          <span className="text-8xl md:text-[96px] font-black leading-none tabular-nums"
            style={{ color: stat.color, textShadow: `0 0 80px ${stat.color}55` }}>{count}</span>
        ...
        <div className="mt-7 space-y-1.5">
          ...
          <div className="h-px rounded-full overflow-hidden" style={{ background: "rgba(255,255,255,0.05)" }}>
            <motion.div className="h-full rounded-full"
              ...
              transition={{ duration: 1.8, ease: [0.16, 1, 0.3, 1], delay: 0.85 }}/>
          </div>
        </div>
      </div>
    </motion.div>
...
function SmallCard({ stat, inView }: { stat: typeof stats[0]; inView: boolean }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-5 right-5 opacity-25">
        <Ring progress={stat.progress} color={stat.color} size={56} stroke={2} inView={inView} delay={0.35}/>
      </div>
      ...
      <div>
        <div className="flex items-end gap-0.5 mb-1">
          <span className="text-[42px] font-black leading-none tabular-nums" style={{ color: stat.color }}>{count}</span>
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div className="absolute top-1/3 left-[12%] w-[480px] h-[480px] rounded-full blur-[160px]"
          animate={{ opacity: inView ? 0.07 : 0 }} transition={{ duration: 1.8 }}
          style={{ background: "#a78bfa" }}/>
        <motion.div className="absolute bottom-0 right-[8%] w-[380px] h-[380px] rounded-full blur-[130px]"
          animate={{ opacity: inView ? 0.055 : 0 }} transition={{ duration: 2, delay: 0.3 }}
      ...
      <div className="relative z-20 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col gap-3 md:gap-4">
            <SmallCard stat={small[0]} inView={inView} />
            <SmallCard stat={small[1]} inView={inView} />
          </div>
          <SmallCard stat={small[2]} inView={inView} />
          <motion.div
            variants={cardVariants}
