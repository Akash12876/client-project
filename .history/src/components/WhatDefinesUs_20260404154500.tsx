  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative w-full flex flex-col items-center justify-center gap-6 mt-4">
          {/* Animated image - always visible, centered */}
          <motion.div
            className="relative max-w-lg w-full h-72 md:h-96 rounded-3xl overflow-hidden shadow-2xl z-30"
          ...
          <motion.div
            className="h-0.5 w-32 border-dashed border-t-2 border-white opacity-60 z-10 mt-6"
            initial={{ scaleX: 0 }}
          ...
          <motion.div
            className="w-14 h-14 bg-white rounded-full border-4 border-purple-300 z-20 mt-6"
            initial={{ scale: 0 }}
            whileInView={{ scale: 1 }}
            viewport={{ once: true, amount: 0.3 }}
