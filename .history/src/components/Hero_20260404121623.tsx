...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col md:flex-row items-center justify-center w-full min-h-screen h-screen py-16 px-4 md:px-8 bg-black overflow-hidden animate-fade-in">
      {/* Image Container */}
      {/* Content Left */}
      <div className="flex flex-col items-center md:items-start justify-center max-w-xl w-full text-center md:text-left order-2 md:order-1 md:mr-16">
        <motion.h1
        ...
        <motion.div
          ...
          className="text-xl md:text-2xl font-medium text-indigo-300 mb-6 h-8 min-h-[2rem]"
        >
          {displayed}
      ...
      <motion.div
        whileHover={{}}
        className="flex-shrink-0 flex justify-center items-center mb-8 md:mb-0 order-1 md:order-2"
      >
        <motion.div
      ...
      {/* Text Content */}
      <div className="flex flex-col items-center justify-center max-w-xl w-full text-center">
        <motion.h1
          initial={{ x: 100, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
          transition={{ duration: 1 }}
          className="text-4xl md:text-6xl font-extrabold text-white mb-2 text-center"
        >
          Paras Sharma
        </motion.h1>
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.5, duration: 1 }}
          className="text-xl md:text-2xl font-medium text-indigo-300 mb-6 h-8 min-h-[2rem] text-center"
        >
          {displayed}
          <span className="animate-pulse">|</span>
        </motion.div>
