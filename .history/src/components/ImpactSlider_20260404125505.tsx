...
export default function ImpactSlider() {
  ...
  return (
    <section ref={sectionRef} className="w-full min-h-screen flex flex-col items-center justify-center bg-black py-16 px-4 md:px-0">
        ...
        <div className="flex gap-8 w-full">
          {slides.map((slide, idx) => (
            <motion.div
              ...
              transition={{ delay: inView ? idx * 0.25 : 0, duration: 0.7, type: "spring", stiffness: 60, damping: 20 }}
