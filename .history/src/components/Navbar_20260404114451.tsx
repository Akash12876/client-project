...
export default function Navbar() {
  return (
    <header className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-8 py-4 animate-fade-in" style={{background: "rgba(0,0,0,0.15)", boxShadow: "none", border: "none"}}>
      {/* Logo */}
