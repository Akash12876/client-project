...
export default function ContactSection() {
  ...
  return (
    <section id="contact" data-contact="true" className="w-full flex justify-center items-center min-h-[70vh] py-14 px-2 md:px-8 bg-black">
      ...
      <motion.div
        ...
        transition={{ duration: 0.8, type: "spring" }}
          className="w-full max-w-[99vw] md:max-w-[92vw] bg-[#111] rounded-[2.5rem] shadow-2xl flex flex-col md:flex-row justify-between items-start md:items-stretch p-2 sm:p-4 md:p-16 gap-4 md:gap-10 relative border-2 border-zinc-800"
      >
