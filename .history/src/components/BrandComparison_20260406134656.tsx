          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-zinc-700 to-zinc-900 flex items-center justify-center shadow-lg">
              ...
              <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                ...
                <line x1="9" y1="9" x2="19" y2="19" stroke="#f472b6" strokeWidth="3" strokeLinecap="round"/>
                <line x1="19" y1="9" x2="9" y2="19" stroke="#f472b6" strokeWidth="3" strokeLinecap="round"/>
              </svg>
            </div>
          ...
          <ul className="flex flex-col gap-5 mt-2">
            {rightPoints.map((point, i) => (
              <motion.li
                ...
                transition={{ type: "spring", stiffness: 120, damping: 14 }}
              >
                <span className="w-6 h-6 flex items-center justify-center rounded-full border-2 border-pink-400 bg-pink-900/30 text-pink-400 mr-2">
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><circle cx="9" cy="9" r="9" fill="#f472b6"/><path d="M6 9l3 3 3-3" stroke="#fff" strokeWidth="2" strokeLinecap="round"/></svg>
                </span>
                {point}
              </motion.li>
            ))}
