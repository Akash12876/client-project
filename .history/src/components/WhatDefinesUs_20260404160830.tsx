    ...
    >
      ...
      >
        ...
        <div className="relative w-full flex flex-col items-center justify-center gap-6 mt-4 lg:mt-0 bg-transparent" style={{minHeight: '520px', maxWidth: '700px', margin: '0 auto'}}>
          ...
          <motion.div
            className="absolute bottom-6 right-6 text-white text-2xl md:text-3xl font-bold px-6 md:px-10 py-6 md:py-8 max-w-xl w-[90vw] md:w-[420px] z-30 text-right rounded-2xl bg-black/40 backdrop-blur-sm shadow-lg"
