...
export default function ContactSection() {
  return (
    <section className="w-full flex justify-center items-center min-h-[70vh] py-14 px-2 md:px-8 bg-black">
      <motion.div
        initial={{ opacity: 0, y: 60 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true, amount: 0.4 }}
        transition={{ duration: 0.8, type: "spring" }}
        className="w-full max-w-[98vw] md:max-w-[92vw] bg-[#111] rounded-[2.5rem] shadow-2xl flex flex-col md:flex-row justify-between items-start md:items-stretch p-6 md:p-16 gap-10 relative border-2 border-zinc-800"
      >
        <div className="flex-1 flex flex-col gap-8 justify-between">
          <div>
            <h2 className="text-4xl md:text-5xl font-extrabold mb-2 text-white leading-tight">
              Elevate Your Influence with <span className="text-[#a78bfa]">IPaR!</span>
            </h2>
