...
import Link from "next/link";
    ...
    <header className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-8 py-4 animate-fade-in backdrop-blur-xl bg-white/10 border-b border-white/20 shadow-lg" style={{boxShadow: "0 4px 32px 0 rgba(31,38,135,0.10)"}}>
...
export default function Navbar() {
  return (
    <header className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-8 py-4 animate-fade-in" style={{background: "rgba(244, 244, 249, 0.15)", boxShadow: "none", border: "none"}}>
      {/* Logo */}
