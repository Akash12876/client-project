...
export default function Navbar() {
  return (
    <header className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-8 py-4 glass animate-fade-in border-none shadow-none" style={{background: "rgba(30,34,80,0.55)", boxShadow: "0 4px 32px 0 rgba(31,38,135,0.10)", border: "1px solid rgba(255,255,255,0.04)"}}>
      {/* Logo */}
