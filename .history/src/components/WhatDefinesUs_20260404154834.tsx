...
export default function WhatDefinesUs() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Speech bubble */}
        <div className="relative w-full flex flex-col items-center justify-center gap-6 mt-4" style={{minHeight: '420px'}}>
          {/* Speech bubble absolutely positioned at top-right of image */}
          <motion.div
            className="absolute top-0 right-0 bg-purple-500 text-white text-2xl md:text-3xl font-bold rounded-3xl px-8 py-8 max-w-md w-[320px] shadow-lg z-30"
          ...
          <motion.div
            className="absolute left-0 bottom-0 max-w-lg w-[320px] h-72 md:h-96 rounded-3xl overflow-hidden shadow-2xl z-20"
