...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col md:flex-row items-center justify-center w-full min-h-screen h-screen py-16 px-4 md:px-8 bg-black overflow-hidden animate-fade-in">
      ...
      <motion.div
        whileHover={{}}
        className="flex-shrink-0 flex justify-center items-center mb-8 md:mb-0 md:mr-16 order-1"
      >
        <motion.div
      ...
      {/* Content Right */}
      <div className="flex flex-col items-center md:items-start justify-center max-w-xl w-full text-center md:text-left order-2">
        <motion.h1
