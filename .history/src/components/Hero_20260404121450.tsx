...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center w-full min-h-screen h-screen py-16 px-4 md:px-8 bg-black overflow-hidden animate-fade-in">
      {/* Image Container */}
      <motion.div
        whileHover={{}}
        className="flex-shrink-0 flex justify-center items-center mb-8 md:mb-0 md:mr-0"
      >
        <motion.div
