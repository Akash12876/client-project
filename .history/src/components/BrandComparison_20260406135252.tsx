  ...
  return (
    <section className="w-full flex flex-col items-center justify-center py-20 px-2 md:px-0 bg-black">
      ...
      <div className="w-full max-w-5xl flex flex-col md:flex-row gap-8 md:gap-16 justify-center items-stretch">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-yellow-400 to-pink-400 flex items-center justify-center shadow-lg">
              {/* Example random logo: a star */}
              <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                <circle cx="14" cy="14" r="14" fill="#fff"/>
                <polygon points="14,5 17,12 25,12 18.5,16.5 21,24 14,19.5 7,24 9.5,16.5 3,12 11,12" fill="#fbbf24" stroke="#f472b6" strokeWidth="1.5"/>
              </svg>
            </div>
