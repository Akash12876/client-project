...
export default function WhatDefinesUs() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="flex-1 flex flex-col items-end justify-end w-full relative mt-12 md:mt-0 z-10"
      ...
      >
        {/* Speech bubble */}
        <motion.div
          className="bg-purple-500 text-white text-2xl md:text-3xl font-bold rounded-3xl px-8 py-8 mb-8 max-w-lg w-full shadow-lg z-20"
        ...
        <div className="relative w-full flex justify-end items-end">
          ...
          <motion.div
            className="absolute right-36 bottom-24 h-0.5 w-32 border-dashed border-t-2 border-white opacity-60 z-10"
            initial={{ scaleX: 0 }}
          ...
          {/* Animated circle */}
          <motion.div
            className="absolute right-16 bottom-16 w-14 h-14 bg-white rounded-full border-4 border-purple-300 z-20"
            initial={{ scale: 0 }}
            whileInView={{ scale: 1 }}
            viewport={{ once: true, amount: 0.3 }}
          ...
          {/* Animated image */}
          <motion.div
            className="relative max-w-lg h-72 md:h-96 rounded-3xl overflow-hidden shadow-2xl z-30"
