...
export default function BrandHero() {
  ...
  return (
    <section className="w-full flex justify-center items-center py-20 px-0 bg-black">
      <motion.h1
        className="select-none w-full text-center text-[clamp(2.5rem,13vw,11vw)] font-black tracking-tight uppercase relative leading-[1.05]"
        style={{
      ...
      >
        <span className="block w-full">IPRAX MEDIA</span>
        <motion.span
