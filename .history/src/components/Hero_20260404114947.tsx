...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col md:flex-row items-center justify-center w-full min-h-[80vh] py-16 px-4 md:px-8 bg-[rgba(30,34,80,0.55)] backdrop-blur-xl overflow-hidden animate-fade-in">
      {/* Image Container */}
      <motion.div
        whileHover={{}}
