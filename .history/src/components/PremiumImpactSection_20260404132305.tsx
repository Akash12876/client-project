...
// and random values for animation.
//
// Place this at the top of your file or in a separate file if needed.

// If you move this to a separate file, add 'use client' at the top of that file.
