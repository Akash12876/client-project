      ...
      >
        <div className="relative z-10 flex flex-col justify-between gap-9">
          ...
          >
            ...
            >
              <span className="absolute inset-0 origin-left scale-x-0 bg-[linear-gradient(90deg,rgba(255,255,255,0.28),rgba(255,255,255,0.1),transparent)] opacity-0 transition-all duration-500 ease-out group-hover:scale-x-100 group-hover:opacity-100" />
