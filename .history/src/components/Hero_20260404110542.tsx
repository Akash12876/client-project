    ...
    <section className="relative flex flex-col md:flex-row items-center justify-between w-full min-h-[80vh] py-16 px-8 bg-gradient-to-br from-black via-zinc-900 to-zinc-800 overflow-hidden">
      ...
      <div className="z-10 flex flex-col items-start gap-4 max-w-lg w-full md:w-1/2">
        ...
        <motion.button
          ...
          className="mt-6 px-8 py-3 bg-indigo-500 hover:bg-indigo-600 text-white font-bold rounded-full shadow-lg transition-all text-lg focus:outline-none focus:ring-2 focus:ring-indigo-400"
        >
          Let's Connect
        </motion.button>
      </div>
      ...
      <div className="z-10 flex justify-center items-center w-full md:w-1/2 mt-12 md:mt-0">
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl p-4 md:p-8 flex flex-col items-center border border-white/20 max-w-xs">
          <img
            src="/profile.jpg"
            alt="Paras Sharma"
