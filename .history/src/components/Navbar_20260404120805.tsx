...
export default function Navbar() {
  return (
    <header className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-8 py-4 animate-fade-in backdrop-blur-xl bg-black/60 border-b border-white/10 shadow-lg" style={{boxShadow: "0 4px 32px 0 rgba(31,38,135,0.10)"}}>
      {/* Logo */}
