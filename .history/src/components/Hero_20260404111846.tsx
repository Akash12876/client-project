...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col md:flex-row items-center justify-center w-full min-h-[80vh] py-16 px-4 md:px-8 bg-gradient-to-br from-indigo-900 via-black to-zinc-900 overflow-hidden animate-fade-in">
      {/* Image Container */}
      <motion.div
        whileHover={{ scale: 1.05, rotate: 2 }}
        className="flex-shrink-0 flex justify-center items-center mb-8 md:mb-0 md:mr-16"
      >
        <div className="rounded-3xl border-4 border-indigo-500 shadow-2xl overflow-hidden bg-gradient-to-br from-zinc-900 via-indigo-900 to-black p-2 transition-transform duration-300">
          <Image
            src="/profile.jpg"
            alt="Paras Sharma"
            width={260}
